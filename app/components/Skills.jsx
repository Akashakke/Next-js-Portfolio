    ...
    <section id="skills" className="text-center">
      ...
      <div className="flex justify-center flex-wrap w-[85%] max-sm:w-[95%] m-auto">
        {skillset.map((skill, i) => (
          <div
            key={i}
            className=" py-4 flex justify-center flex-col items-center rounded-xl mx-4 my-4 w-[6rem]  hover:bg-[linear-gradient(_90deg,rgb(19,165,223),rgb(19,165,223))] hover:scale-110 transition-all ease-in-out duration-5000"
          >
